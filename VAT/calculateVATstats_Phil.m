...
%Adaptation of this function to run on Phil's local machine
%   Here we calculate the proportion of each volume of activated tissue within each subregion of the subthalamic nucleus
%inputs
