...
for s = 1:length(subFolders)
    ...
    if isempty(cors)
        ...
        Rmotorperc=[length(Rmotoroverlap)./length(r1)]*100;
    end
    ...
    if isempty(cors)
        ...
        Lmotorperc=[length(Lmotoroverlap)./length(l1)]*100;
    end
    ...
    if isempty(cors)
        ...
        Rassocperc=[length(Rassocoverlap)./length(r1)]*100;
    end
    ...
    if isempty(cors)
        ...
        Lassocperc=[length(Lassocoverlap)./length(l1)]*100;
    end
